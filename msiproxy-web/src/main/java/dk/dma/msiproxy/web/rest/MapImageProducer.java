 ...
 */
package dk.dma.msiproxy.web.rest;

import dk.dma.msiproxy.common.settings.annotation.Setting;
import dk.dma.msiproxy.common.util.GraphicsUtils;
...
/**
 * Produces a thumbnail image for given locations.
 */
public class MapImageProducer {
    ...
    @Inject
    @Setting(value = "mapImageServer", defaultValue = "http://osm.e-navigation.net/staticmap.php")
     ...
     */
    public boolean createMapImage(List<Location> locations, Path imageRepoPath, Image pointIndicator, Date imageDate) throws IOException {
